...
@Component({
  selector: 'app-mtsoscategory',
  templateUrl: './mtsoscategory.component.html',
  styleUrls: ['./mtsoscategory.component.css']
})
export class MtsoscategoryComponent implements OnInit {
