...
@Component({
  selector: 'app-mtcomplaintcategory', 
  templateUrl: './mtcomplaintcategory.component.html',
  styleUrls: ['./mtcomplaintcategory.component.css']
})
export class MtcomplaintcategoryComponent implements OnInit {
  cTitle: any;
  cDesc: any;
  ...
  constructor(private modalService: BsModalService, private srv: ComplaintService, protected global: GlobalService, protected el: ElementRef) {
    this.cols = [
