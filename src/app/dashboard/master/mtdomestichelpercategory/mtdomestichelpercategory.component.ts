...
@Component({
  selector: 'app-mtdomestichelpercategory',
  templateUrl: './mtdomestichelpercategory.component.html',
  styleUrls: ['./mtdomestichelpercategory.component.css']
})
export class MtdomestichelpercategoryComponent implements OnInit {
  cTitle: any;
  cDesc: any;
  ...
  constructor(private modalService: BsModalService, private srv: DomesticHelperService, protected global: GlobalService, protected el: ElementRef) {
    this.cols = [
