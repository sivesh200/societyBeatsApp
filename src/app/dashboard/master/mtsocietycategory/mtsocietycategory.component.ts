...
@Component({
  selector: 'app-mtsocietycategory',
  templateUrl: './mtsocietycategory.component.html',
  styleUrls: ['./mtsocietycategory.component.css']
})
export class MtsocietycategoryComponent implements OnInit {
  ...
  constructor(private modalService: BsModalService, private srv: SocietyService, protected global: GlobalService, protected el: ElementRef) {
    this.cols = [
